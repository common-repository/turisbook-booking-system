...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="material-icons" style="font-size:16px; vertical-align:middle;">insert_drive_file</i>&nbsp;';
            tCaption = '<div tabindex="500" class="textfield__input file-caption {class}">\n' +
                '   <div class="file-caption-name"></div>\n' +
                '</div>\n';
            //noinspection HtmlUnknownAttribute
            tBtnDefault = '<button type="{type}" tabindex="500" title="{title}" class="{css} small has-child" ' +
                '{status}>{icon} {label}</button>';
            //noinspection HtmlUnknownAttribute
            tBtnLink = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>';
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<div tabindex="500" class="{css} small has-child" {status}>{icon} {label}</div>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: false,
                    showDrag: true,
                    removeIcon: '<i class="material-icons">delete</i>&nbsp',
        ...
        _renderButton: function (type) {
            ...
            if (!$h.isEmpty(label)) {
                label = ' <span style="vertical-align: middle;" class="' + self.buttonLabelClass + '">' + label + '</span>';
            }
            return tmplt.setTokens({
        ...
        clear: function () {
            ...
            if (self.$container.find($h.FRAMES).length === 0) {
                if (!self._initCaption()) {
                    self.$captionContainer.find('.<i class="material-icons">insert_drive_file</i>').hide();
                }
            }
            self._hideFileIcon();
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            prev: 'btn navigate',
            next: 'btn navigate',
            toggleheader: 'btn default btn-header-toggle',
            fullscreen: 'btn default',
            borderless: 'btn default',
            close: 'btn default'
        },
        ...
        browseIcon: '<i class="material-icons" style="vertical-align: middle;">folder_open</i>&nbsp;',
        browseClass: 'btn primary',
        removeIcon: '<i class="material-icons" style="vertical-align: middle;">delete</i>&nbsp;',
